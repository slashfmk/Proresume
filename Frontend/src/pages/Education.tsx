...
const Education: React.FC<any> = () => {
    ...
    const educationQuery = useQuery('education', async () => await axios.get(`${apiUrl}/education/resume/${param.resumeId}`));
    const [openModal, setOpenModal] = useState(false);

    const mutation = useMutation(async (login: MyFormValues) => {
        return await axios.post(`${apiUrl}/education/${param.resumeId}`, login);
    }, ({
    ...
    return <div className={"home--split"}>
        ...
        <div className="main__container">
            ...
            <div className={"title--xxx gen_title "}>Education | Resume {param.resumeId}</div>
